...
import static org.apache.doris.catalog.AggregateType.BITMAP_COUNT;
...
public class SchemaChangeHandler extends AlterHandler {
    ...
    private void addColumnInternal(OlapTable olapTable, Column newColumn, ColumnPosition columnPos,
        ...
        if (newColumn.getAggregationType() == BITMAP_COUNT  && KeysType.AGG_KEYS != olapTable.getKeysType()) {
            throw new DdlException("BITMAP_COUNT must be used in AGG_KEYS");
        }
