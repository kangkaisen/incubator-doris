...
dst);
    ...
    static void bitmap_count_init(doris_udf::FunctionContext* ctx, doris_udf::StringVal* slot);
    static void bitmap_count_update(doris_udf::FunctionContext* ctx, const doris_udf::StringVal& src,
                                    doris_udf::StringVal* dst);
    static void bitmap_count_merge(doris_udf::FunctionContext* ctx,const doris_udf::StringVal& src,
                                   doris_udf::StringVal* dst);
    static StringVal bitmap_count_serialize(doris_udf::FunctionContext* ctx, const doris_udf::StringVal& src);
    static doris_udf::BigIntVal bitmap_count_finalize(doris_udf::FunctionContext* ctx, const StringVal& src);
};
