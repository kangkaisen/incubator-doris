...
void AggregateFunctions::bitmap_count_init(FunctionContext* ctx, StringVal* dst) {
    dst->is_null = false;
    dst->len = sizeof(RoaringBitmap);
    dst->ptr = (uint8_t*)new RoaringBitmap();
}

void AggregateFunctions::bitmap_count_update(FunctionContext* ctx, const StringVal& src, StringVal* dst) {
    if (src.is_null) {
        return;
    }
    DCHECK(!dst->is_null);
...
void AggregateFunctions::bitmap_count_merge(FunctionContext* ctx, const StringVal& src, StringVal* dst) {
    DCHECK(!dst->is_null);
    DCHECK(!src.is_null);
...
StringVal AggregateFunctions::bitmap_count_serialize(FunctionContext* ctx, const StringVal& src) {
    DCHECK(!src.is_null);
...
BigIntVal AggregateFunctions::bitmap_count_finalize(FunctionContext* ctx, const StringVal& src) {
    auto* src_bitmap = reinterpret_cast<RoaringBitmap*>(src.ptr);
    BigIntVal result(src_bitmap->cardinality());
    delete src_bitmap;
    return result;
